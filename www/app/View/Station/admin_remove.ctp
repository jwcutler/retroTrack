...
<br /><br />
<form action="<?php echo $this->webroot; ?>admin/station/<?php echo $station['Station']['id']; ?>/delete" method="POST">
    <button type="submit" name="delete_confirmation" class="btn btn-danger">Yes, Delete Ground Station</button>
    <a href="<?php echo $this->webroot; ?>admin/station" class="btn btn-primary">Nevermind</a>
</form>
<?php
$this->end();
?>
