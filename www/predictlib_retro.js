...
*                                                                           *
*****************************************************************************/
/* Upgrades for retroTrack.
   *
   * - updated parseInt in Calc() for PLib.rv calcs to force base 10.  Was 
   *   getting confused by a leading 0 in the TLE file. --jwc
   * - Removed rounding of isplat and isplong so it can be customized by
   *   by application code.  --jwc
   *
   */
